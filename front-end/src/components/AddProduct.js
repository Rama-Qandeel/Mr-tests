  ...
  return (
    <div className="modaladd">
      ...
      <div className="header">
        ...
        return <option key={key} value={e.store_id}>{e.store_name}</option>;
    })}
          </select>
          </div>
        <div>
        ...
        return <option key={key} value={e.product_category_id}>{e.categoryName}</option>;
    })}
          </select>
          </div>
        <div>
        ...
        <div>
          ...
          <select name="available product" id="available product" onClick={handleChange}>
